...
function enqueue_parent_styles() {
  ...
  wp_enqueue_style($parent_style, get_template_directory_uri().'/style.css?v=fjdklsfdjskl');
  wp_enqueue_style('child-style', get_stylesheet_directory_uri().'/style.css?v=fjdkfjdklsfdjeilsfdjskl',
                   array($parent_style),
